...
namespace braft
{
    ...
    public:
        IOMetric()
            : start_time_us(butil::cpuwide_time_us()), bthread_queue_time_us(0), open_segment_time_us(0), append_entry_time_us(0), sync_segment_time_us(0) {}
    ...
    /**
 * 用来存放一些RAFT算法自身的状态数据， 比如term, vote_for等信息
 */
