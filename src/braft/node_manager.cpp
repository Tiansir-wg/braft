...
namespace braft
{
    ...
    // 把braft相关的service添加到brpc server里面
                                 ...
                                 const butil::EndPoint &listen_address)
    {
        ...
        // RaftServiceImpl主要和raft协议有关，有一些选举、append_entries和快照相关的接口
        ...
        // CliServiceImpl负责管理braft相关的工作，比如add_peer，get_leader，transfer_leader等操作
