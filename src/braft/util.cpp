...
namespace bvar
{
    ...
    namespace detail
    {
        ...
        {
            return ((CounterRecorder *)arg)->counter_percentile((double)numerator / double(denominator));
        }
        ...
        CounterRecorderBase::CounterRecorderBase(time_t window_size)
            : _max_counter(), _avg_counter_window(&_avg_counter, window_size), _max_counter_window(&_max_counter, window_size), _counter_percentile_window(&_counter_percentile, window_size), _total_times(get_recorder_count, &_avg_counter), _qps(get_window_recorder_qps, &_avg_counter_window), _counter_p1(get_p1_counter, this), _counter_p2(get_p2_counter, this), _counter_p3(get_p3_counter, this), _counter_999(get_counter_percetile<999, 1000>, this), _counter_9999(get_counter_percetile<9999, 10000>, this), _counter_cdf(&_counter_percentile_window), _counter_percentiles(get_counters, &_counter_percentile_window)
        {
        }
